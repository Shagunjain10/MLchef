...
WSGI_APPLICATION = 'MLchef.wsgi.application'
...
# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') #change 
# STATIC_URL = '/static/'

# MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #change 
# MEDIA_URL = '/media/'
